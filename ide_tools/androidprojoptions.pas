...
begin
  ...
  CreateBuildXML(pathToAndroidProject, pathToAndroidSDK, DefaultTheme, IntToStr(FTargetSdkVersion),
  ...
  CreateProjectProperties(pathToAndroidProject, DefaultTheme, IntToStr(FTargetSdkVersion), true);
  {
  strList.Clear;
...
begin
  ...
  FManifest.DefaultTheme := cbTheme.Text;
end;
